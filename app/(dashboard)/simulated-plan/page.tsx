...
import { Rocket, RotateCcw, ArrowLeft, Loader2, AlertCircle, CheckCircle2 } from "lucide-react";
...
export default function SimulatedPlanPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Intake form OR live agent progress */}
      {!submitted ? (
        ...
        <>
          ...
          {!executionPlanComplete && !executionPlanError && (
